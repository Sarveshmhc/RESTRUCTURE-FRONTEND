...
const mockMessages: Message[] = [
  {
    id: "1",
    from: { name: "Sarah Johnson", email: "sarah.johnson@company.com", role: "HR Manager" },
    to: ["emp@company.com"],
    subject: "Leave Request Approval Required",
    content: "Hi, I need your approval for John Doe's leave request for next week.",
  ...
  {
    id: "2",
    from: { name: "IT Support", email: "support@company.com", role: "IT Department" },
    to: ["emp@company.com"],
    subject: "System Maintenance Notification",
    content: "We will be performing system maintenance this Saturday from 2 AM to 6 AM.",
  ...
  return (
    ...
    <div className={styles.inboxRoot}>
      ...
      <header className={styles.inboxHeader}>
        <div>
          <h1 className={styles.inboxTitle}>HR Inbox</h1>
          <p className={styles.inboxSubtitle}>Manage company and employee communications</p>
        </div>
          ...
          <div className={styles.messageListScroll}>
            {filteredMessages.length === 0 ? (
              ...
              filteredMessages.map((msg) => (
                <div
                  key={msg.id}
                  className={`${styles.messageItem} ${selectedMessage?.id === msg.id ? styles.messageItemActive : ""
            ...
            {mockContacts.map((contact) => (
              <div key={contact.id} className={styles.contactItem}>
                <div className="relative">
                  ...
                  <div
                    className={`absolute -bottom-1 -right-1 w-3 h-3 rounded-full border-2 border-white ${contact.status === "online"
                        ? "bg-green-500"
                        : contact.status === "away"
                          ? "bg-yellow-500"
                          : "bg-gray-400"
